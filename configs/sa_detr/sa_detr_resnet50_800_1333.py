"""SA-DETR with a ResNet-50 backbone, HSAE neck, and TRRO encoder."""
...
from models.bricks.sa_transformer import (
    SATransformer,
    SATransformerDecoder,
    SATransformerDecoderLayer,
    SATransformerEncoder,
    SATransformerEncoderLayer,
)
from models.bricks.set_criterion import HybridSetCriterion
from models.detectors.sa_detr import SADETR
from models.matcher.hungarian_matcher import HungarianMatcher
from models.necks.channel_mapper_hsae import HSAEChannelMapper
...
transformer = SATransformer(
    encoder=SATransformerEncoder(
        encoder_layer=SATransformerEncoderLayer(
            embed_dim=embed_dim,
            n_heads=num_heads,
            dropout=0.0,
    ...
    decoder=SATransformerDecoder(
        decoder_layer=SATransformerDecoderLayer(
            embed_dim=embed_dim,
            n_heads=num_heads,
            dropout=0.0,
            activation=nn.ReLU(inplace=True),
